...
from yyskmultilearn.cluster.tests.test_networkx import get_networkx_clusterers
from yyskmultilearn.cluster.tests.test_matrix import get_matrix_clusterers

if (sys.platform != 'win32') and (sys.platform != 'darwin' and sys.version_info[0] == 2):
    from yyskmultilearn.cluster.tests.test_graphtool import get_graphtool_partitioners
    from yyskmultilearn.cluster.tests.test_igraph import get_igraph_clusterers
