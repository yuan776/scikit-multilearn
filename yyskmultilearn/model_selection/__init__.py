"""
The :mod:`yyskmultilearn.model_selection` module provides implementations multi-label stratification methods
...
| Name                                                              | Description                               |
+===================================================================+===========================================+
| :class:`~yyskmultilearn.model_selection.iterative_stratification`   | Iterative stratification                  |
+-------------------------------------------------------------------+-------------------------------------------+
| :mod:`~yyskmultilearn.model_selection.measures`                     | Stratification quality measures package   |
+-------------------------------------------------------------------+-------------------------------------------+
